...
def banner():
    print("""\x1b[0;33m   ___                   \n  / _ \_______             ® \n / ___/ __/ -_) Multi Brute  ┌──────────────────────────────┐\n/_/  /_/__\__/(_) Force 3.0  │  Script By  WaqarAj      │\n       /  ^ \/ / // /  ^ \   │   •• Github.com/Waqarop ••  │\n      /_/_/_/_/\_,_/_/_/_/   └──────────────────────────────┘""")
...
def gen():
        ...
        try:
                ...
                "user-agent"                : "Mozilla/5.0 (Linux; Android 10; Infinix X682C) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.71 Mobile Safari/537.36", # Jangan Di Ganti Ea Anjink.
...
def defaultua():
    ua = "  Mozilla/5.0 (Linux; Android 10; Infinix X682C) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.71 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]"
    try:
